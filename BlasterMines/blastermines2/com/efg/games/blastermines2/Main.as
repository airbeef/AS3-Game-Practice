package com.efg.games.blastermines2 
{
	...
	//Molly's Suggestion
	import com.efg.games.blastermines2.TitleScreen;
	import com.efg.games.blastermines2.DummyScreen;
	import com.efg.games.blastermines2.ScoreScreen;
	...
	public class Main extends GameFrameWork
	{
		...
		//ui page test
		private var titleBitmapData:BitmapData = new PHBackground(0,0) ; //Mine1(150,150
		...
		override public function addedToStage(e:Event = null):void
		{
			...
			super.addedToStage();
			trace("in blastermines2 added to stage");
			init();
		}
		...
		{
			trace("init");
			game = new BlasterMines2(); //BlasterMinesImg2
			
			//Game parameters
			setApplicationBackGround(600, 400, false, 0x555555); //0x000000);
			...
			//Molly's Suggestions pt 3
			var gameSpecificTitleScreen:TitleScreen = new TitleScreen(FrameWorkStates.STATE_SYSTEM_TITLE, 400,400, false, 0x000000);
			gameSpecificTitleScreen.createDummyButton("Dummy", new Point(150, 200), 100, 20, screenButtonFormat, 0x000000); //only needed 6 arguments  (0xff0000,2)
			gameSpecificTitleScreen.createOkButton("Play", new Point(150,250), 100, 20, screenButtonFormat, 0x000000, 0xff0000,2);
			titleScreen = gameSpecificTitleScreen;
			/*
			//Suggestion #4?
			var secondSpecificScreen:DummyScreen = new DummyScreen(FrameWorkStates.STATE_SYSTEM_DUMMY, 400, 400, false, 0x000000);
			secondSpecificScreen.createDisplayText("This is Dummy.", 200, new Point(100, 150), screenTextFormat);
			secondSpecificScreen.createBackButton("Back", new Point(150, 200), 100, 20, screenButtonFormat, 0x000000);
			secondSpecificScreen.createScoreTest("Score", new Point(150, 200), 100, 20, screenButtonFormat, 0x000000);
			//create Title button
			dummyScreen = secondSpecificScreen;
						
			//Sample Local Scoreboard
			var sampleScoreScreen:ScoreScreen = new ScoreScreen(FrameWorkStates.STATE_SYSTEM_SCORE_SCREEN, 400, 400, false, 0x000000);
			sampleScoreScreen.createDisplayText("Local Scoreboard.", 200, new Point(100, 50), screenTextFormat);
			sampleScoreScreen.scoreBackButton("Title", new Point(150, 350), 100, 20, screenButtonFormat, 0x000000);
			//This is a new sample screen that will be a local scoreboard
			scoreScreen = sampleScoreScreen;
			*/
			
			/*//Image added Update 10.17.13
			...
			titleScreen.createImageButton(new PHButton1(0,0),new PHButton2(0,0), new Point(150, 250));*/
			...
			//instructionsScreen.addImage(titleBitmapData);
			...
			//instructionsScreen.useImageButton = true;
			//instructionsScreen.createImageButton(new PHButton1(0,0),new PHButton2(0,0), new Point(150, 250));
			...
			//gameOverScreen.addImage(titleBitmapData);
			//addChild(gameOverScreen);
			gameOverScreen.createDisplayText("Game Over.", 100, new Point(150, 150), screenTextFormat);
			//gameOverScreen.useImageButton = true;
			//gameOverScreen.createImageButton(new PHButton1(0,0),new PHButton2(0,0), new Point(150, 250));
			
			levelInScreen = new BasicScreen(FrameWorkStates.STATE_SYSTEM_LEVEL_IN, 400, 400, false, 0x000000); //0Xbbff00ff
			//levelInScreen.addImage(titleBitmapData);
			//addChild(levelInScreen);
			levelInText = "Level ";
			levelInScreen.createDisplayText(levelInText, 100, new Point (150, 150), screenTextFormat);
			
			pausedScreen = new BasicScreen(FrameWorkStates.STATE_SYSTEM_PAUSE, 400, 400, true, 0x000000); //false
			pausedScreen.createOkButton("Unpause", new Point(150,250), 100, 20, screenButtonFormat, 0x000000, 0xff0000, 2); //150,250
			...
			frameRateProfiler.profilerDisplayOnScreen = false; //true
			frameRateProfiler.profilerXLocation = 0;
			frameRateProfiler.profilerYLocation = 0;
			
			addChild(frameRateProfiler);
			
			frameRateProfiler.startProfile(frameRate); //this sets text for laoding screen
			...
			override public function frameRateProfileComplete(e:Event):void
			{
				...
				frameCounter.x = 400; //400
				frameCounter.y = 200;
				
				frameCounter.profiledRate = frameRateProfiler.profilerFrameRateAverage;
				frameCounter.showProfiledRate = false; //true
				//addChild(frameCounter); //this gets rid of the weird text errors on screen
				startTimer(true);		
			} 
			...
			{
				//Have to stop this from hiccuping
			}
			*/
